...
toolbox_title = "armadilloToolbox";
...
Function_Names = [        
        "armaMatFunc","armadilloMatFunc","csci6";
        "armaMat","armadilloMat","csci6";
        "armaVec","armadilloVecFunc","csci6";
        "armaStat","armadilloStatistics","csci6";
        "armaClust","armadilloCluster","csci6";
        "armaImage","armadilloImage","csci6";
        "armaDenseMat","armadilloDenseMat","csci6";
    ];

//Name of all the files to be compiled

Files = [
"armadilloMatFunc.cpp", 
"armadilloMat.cpp", 
"armadilloVecFunc.cpp",
"armadilloStatistics.cpp",
"armadilloCluster.cpp",
"armadilloImage.cpp",
"armadilloDenseMat.cpp"
]
...
elseif getos()=="Darwin" then //Mac
    ...
    C_Flags = ["-I"+inc_base_dir];
		...
		Linker_Flag = ["-L" + lib_base_dir + " -larmaMat -Wl,-rpath="+lib_base_dir]
